...
<div class="card">
    ...
    <div class="card-body">
      <form method="post" action="{{route('brand.update',$brand->id)}}">
        ...
        <input id="inputTitle" type="text" name="address" placeholder="Enter title"  value="{{$brand->address}}" class="form-control">
        @error('address')
        <span class="text-danger">{{$message}}</span>
        @enderror
        </div> 
        ...
        <div class="form-group">
          <label for="inputTitle" class="col-form-label">Mobile <span class="text-danger">*</span></label>
        <input id="inputTitle" type="text" name="mobile" placeholder="Enter title"  value="{{$brand->mobile}}" class="form-control">
        @error('mobile')
        <span class="text-danger">{{$message}}</span>
        @enderror
        </div> 
